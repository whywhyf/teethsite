  ...
  publicAPI.getWidgetForView = function (_ref) {
    ...
    if (!viewToWidget[viewId]) {
      ...
      if (model.dependingPoints){
        ...
        widgetModel.renderer = model.renderer;
        widgetModel.renderWindow = model.renderWindow;
        widgetPublicAPI.updatePosFunc = model.updatePosFunc;
      }
      // 牙弓线小球传入的方法
      if (model.afterModifyLinkLength){
        widgetPublicAPI.afterModifyLinkLength = model.afterModifyLinkLength
      }

...
import vtkAbstractWidgetFactory from './SphereWidget/Core/AbstractWidgetFactory.js';
...
function extend(publicAPI, model) {
  ...
  macro.setGet(publicAPI, model, ['manipulator', 'widgetState', 'renderer', 'renderWindow']);
